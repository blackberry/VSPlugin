...
if /i "%arg%" == "/script"       set ActionGenScripts=1
...
if /i "%arg%" == "/debug-script" set ActionDebugScript=1
...
if ActionDebugScript neq 0 set PluginPath=S:\vs-plugin\src_vs%VSYear%\DebugEngine\bin\Debug
